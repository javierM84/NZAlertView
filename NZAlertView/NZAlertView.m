...
- (void)hide {
    ...
    CGRect viewFrame = CGRectMake(-(CGRectGetWidth([[UIScreen mainScreen] bounds]) / 2) + self.view.frame.size.width / 2, 0, CGRectGetWidth([[UIScreen mainScreen] bounds]), self.view.frame.size.height);
